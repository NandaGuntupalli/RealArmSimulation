...
public class Arm implements AutoCloseable {
  ...
  private final PIDController m_controller = new PIDController(m_armKp, m_armKi, 0);
  ...
  private final MechanismLigament2d m_armTower =
      m_armPivot.append(new MechanismLigament2d("ArmTower", 10, 0));
